...
NAVIGATE_CHROME_CDP_SCRIPT="$ROOT_DIR/chrome_cdp_navigate.mjs"
...
PORT="$PORT" USER_DATA_DIR="$USER_DATA_DIR" "$LAUNCH_CHROME_CDP_SCRIPT" >/dev/null
CDP_PORT="$PORT" CDP_NAV_URL="$URL" node "$NAVIGATE_CHROME_CDP_SCRIPT"
